...
2️⃣ നിങ്ങൾ ചോദിച്ച സിനിമ തീയറ്ററിൽ റിലീസ് ആയതാണോ എന്ന്  ഉറപ്പുവരുത്തുക @PRE_DVD_UPDTES യിൽ ചെക്ക് ചെയ്യുക..!!
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("🔻𝐒𝐄𝐍𝐃 𝐀𝐋𝐋 𝐅𝐈𝐋𝐄𝐒🔻", callback_data=f"sendfiles#{key}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
            InlineKeyboardButton("👥 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐆𝐫𝐨𝐮𝐩", url=f"https://t.me/+-mQFc19bxQlmODY1"),
